...
! function (t) {
    ...
    e.clone = c, e.addLast = l, e.addFirst = d, e.removeLast = p, e.removeFirst = v, e.insert = h, e.removeAt = E, e.replaceAt = g, e.getIn = _, e.set = y, e.setIn = m, e.update = I, e.updateIn = b, e.merge = T, e.mergeDeep = w, e.mergeIn = O, e.omit = A, e.addDefaults = S;
    /*!
     * Timm
     *
    ...
    n(121), n(122), n(124), n(65), n(126), n(314), n(315), n(316), n(317), n(322), t.exports = n(323)
}, function (t, e, n) {
    "use strict";
    var r = n(0)(n(13));
    ! function () {
    ...
    t.exports = function (t, e, n, E, g, _) {
        ...
        if (O && !T) return _ || (_ = new r), y || f(t) ? i(t, e, n, E, g, _) : o(t, e, I, n, E, g, _);
        if (!(n & l)) {
    ...
    var r = n(2),
        ...
        b = function (t, e) {
            ...
            if (E && !g)
                for (var D = 0, P = a.length; D < P; D++) {
                    ...
                    for (var j = (T - _) / m, F = E.config.easing, k = h(F, j, f), X = 0, G = a.length; X < G; X++) {
                        var V = a[X],
                            U = y(s, V, E.config),
        ...
        T = function (t, e) {
            var n = t,
                ...
                I = m.duration,
                b = m.delay;
            null != p && (I = p), b = null != E ? E : b, c === g ? I = 0 : u && (I = b = 0);
            var T = e.payload.now;
            if (r && i) {
                var w = T - (a + b);
                if (s) {
    ...
    i.define("forms", t.exports = function (t, e) {
        ...
        function m(e, n) {
            ...
            i.handler = null, i.redirect = r.attr("data-redirect"), _.test(u) ? i.handler = O : u || (o ? i.handler = w : y())
        }
...
Webflow.require('ix2').init({
    "events": {
        "e": {
            ...
            "target": {
                "selector": ".tab-link",
                "originalId": "60321e15a46eb01994d8020d|7640ff02-0c6e-c320-70e4-2a07257b869d",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".tab-link",
        ...
        "e-3": {
            ...
            "target": {
                ...
                "originalId": "60321e15a46eb01994d8020d|6583e916-f5c6-6316-804c-8e5f6b6bec6b",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".lightbox-link",
        ...
        "e-5": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "selector": ".text-link-wrapper",
                "originalId": "602eda4894ba7a690d12d810|44928548-c4da-2045-f8d6-3f7ba5a866d9",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".text-link-wrapper",
        ...
        "e-6": {
            ...
            "createdOn": 1613727872438
        }
    },
    "actionLists": {
        "a": {
            "id": "a",
            "title": "Tab Link Hover In",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-n",
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".tab-link-tooltip",
                            "selectorGuids": ["082b700e-ff86-febd-3f57-4c50ab0a552a"]
                        },
                        "xValue": 10,
                        "yValue": -50,
                        "xUnit": "px",
            ...
            "createdOn": 1613899331756
        },
        "a-2": {
            "id": "a-2",
            "title": "Tab Link Hover Out",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-2-n",
                    "actionTypeId": "TRANSFORM_MOVE",
                ...
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selectorGuids": ["c93c6ead-6f30-311e-981d-8898a0364178"]
                        },
                        "xValue": 0.5,
                        "yValue": 0.5,
                        "locked": true
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": "CHILDREN",
                            "selector": ".lightbox-thumbnail-image",
                            "selectorGuids": ["4a429e88-5cba-1e79-b7c5-14bb01b39691"]
                        },
                        "xValue": 1,
                        "yValue": 1,
                        "locked": true
